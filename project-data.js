...
window.PROJECT_DATA = {
  ...
  generalizationDemos: [
    { src: "assets/videos/gen1.mp4", setting: "Background", fo: "Coke Zero Can" },
    { src: "assets/videos/gen2.mp4", setting: "Background", fo: "Coke Zero Can" },
    { src: "assets/videos/gen3.mp4", setting: "Clutter Scene", fo: "Coke Original Can" },
    { src: "assets/videos/gen4.mp4", setting: "Clutter Scene", fo: "Coke Zero Can" },
  ],
  taskPrompts: {
